...
extern pair<double,Vector> calc_periodic_dist(Vector target, Vector to_copy);
extern Vector calc_iner_force(vector<Molecule> Molecules, Vector inertionCenter, Vector inertionCenterNew);
